...
incinerator.energy_source.emissions = ((SLUDGE_PER_TOXIC_BARREL*POLLUTED_AIR_RATIO*TOXIC_SLUDGE_RATIO)*(1-TOXIC_SLUDGE_BURN_PERCENT) / (((SLUDGE_PER_TOXIC_BARREL * MJ_PER_TOXIC_SLUDGE) / 10)*60*10000))
